...
function rescan(lev) {
  ...
  if (stop_b != 1)
    (bk = move.find(".black.node:contains('O-O'):not(:contains('O-O-O'))")
      ...
      ? ""
      : "k")
      ? (bq = move.find(".black.node:contains('O-O-O')").length
          ? (bk = "")
          : "q")
      : (bq = "");
  if (s_br != 1) {
  ...
  if (stop_w != 1)
    (wk = move.find(".white.node:contains('O-O'):not(:contains('O-O-O'))")
      ...
      ? ""
      : "K")
      ? (wq = move.find(".white.node:contains('O-O-O')").length
          ? (wk = "")
          : "Q")
      : (wq = "");
  if (s_wr != 1) {
...
function get(lev, speed) {
  speed = typeof speed === "undefined" ? 5 : speed;
  var response = "";

  $.ajax({
    url: "http://localhost:8080/",
    data: { fen: str2, lev: lev, speed: speed },
    type: "POST",
    error: function (jqXHR, textStatus) {
      if (textStatus === "timeout") {
        // alert("Failed, timeout 5s");
      }
    },
    success: function (text) {
      ...
      if (response.split(" ")[0] == "bestmove") {
        ...
        //       res2 +
        //       ' bro" style="background-color: rgb(235, 97, 80); opacity: 0.71;" data-test-element="highlight"></div>'
        //   )
        //   .children(":first")
        //   .delay(1800)
        //   .queue(function () {
        ...
        //   alert("Timeout per move has reached, use lower depth level!");
      }
    },
    timeout: 5000,
  });
...
//auto mode
isauto = null;
function automoderun(lev) {
  automodestop();
  if (isauto != 1) {
    console.log("Auto-highlighted mode activated");
    rescan();
    get(lev);
    !(function (e) {
      "use strict";
      ...
      var l = function (l, n, a) {
          (this.selector = l.trim()),
            (this.callback = n),
            (this.options = a),
            (function (l) {
              if (!e.find.tokenize)
              ...
              (l.isCombinatorial = !1),
                ...
                (l.isComplex = !1);
              for (
                var n = e.find.tokenize(l.selector), a = 0;
                a < n.length;
                a++
              )
                for (var o = 0; o < n[a].length; o++)
                  -1 != t.indexOf(n[a][o].type) && (l.isCombinatorial = !0),
                    -1 != i.indexOf(n[a][o].type) && (l.isFraternal = !0),
                    -1 != r.indexOf(n[a][o].type) && (l.isComplex = !0);
            })(this);
        },
        n = [];
      (n.initialize = function (t, i, r) {
        var n = [],
          a = e(r.target).find(t).size(),
          o = new l(
            t,
            function () {
              -1 == n.indexOf(this) && (n.push(this), e(this).each(i));
            },
            r
          );
        this.push(o);
        var s = new MutationObserver(function (t) {
            for (var i = [], r = 0; r < t.length; r++)
              if (
                ("attributes" == t[r].type &&
                  (t[r].target.matches(o.selector) && i.push(t[r].target),
                  o.isFraternal
                    ? i.push.apply(
                        i,
                        t[r].target.parentElement.querySelectorAll(o.selector)
                      )
                    : i.push.apply(
                        i,
                        t[r].target.querySelectorAll(o.selector)
                      )),
                "childList" == t[r].type)
              )
                for (var l = 0; l < t[r].addedNodes.length; l++)
                  t[r].addedNodes[l] instanceof Element &&
                    (t[r].addedNodes[l].matches(o.selector) &&
                      i.push(t[r].addedNodes[l]),
                    o.isFraternal
                      ? i.push.apply(
                          i,
                          t[r].addedNodes[l].parentElement.querySelectorAll(
                            o.selector
                          )
                        )
                      : i.push.apply(
                          i,
                          t[r].addedNodes[l].querySelectorAll(o.selector)
                        ));
            i.splice(0, a + 1);
            for (var n = 0; n < i.length; n++) e(i[n]).each(o.callback);
          }),
          c = { childList: !0, subtree: !0, attributes: o.isComplex };
        return s.observe(r.target, r.observer || c), s;
      }),
        (e.fn.initialize = function (t, i) {
          return n.initialize(
            this.selector,
            t,
            e.extend({}, e.initialize.defaults, i)
          );
        }),
        (e.initialize = function (t, i, r) {
          return n.initialize(t, i, e.extend({}, e.initialize.defaults, r));
        }),
        (e.initialize.defaults = {
          target: document.documentElement,
          observer: null,
        });
    })(jQuery);
    obs = $.initialize(
      ".move:last-child > ." + color + "",
      function () {
        rescan();
        get(lev);
      },
      { target: document.getElementsByClassName("vertical-move-list")[0] }
    );
  }
  isauto = 1;
}
...
function automodestop() {
  if (isauto == 1) {
    obs.disconnect();
    console.log("Auto-highlight mode has been stopped");
  }
  isauto = 0;
  stop_b = stop_w = 0;
  s_br = s_br2 = s_wr = s_wr2 = 0;
...
elm1 = (elm1 = document.getElementById("board-layout-player-top"))
  ? elm1
  : document.getElementsByClassName("layout-top-player")[0];
if (elm1) {
  var timeout;
  var lastTap = 0;
...
console.log("Chrome Chess.com BestMove Helper plugin is loaded");
